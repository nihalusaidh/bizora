...
export async function middleware(request: NextRequest) {
  ...
  const isPublicPage = pathname === "/" || isAuthPage || isOnboardingPage || pathname.startsWith("/shop") || pathname.startsWith("/store") || pathname.startsWith("/pricing") || pathname.startsWith("/download") || pathname.startsWith("/faq") || pathname.startsWith("/security");
